...
local title        = ask("Titre de la réunion  ", yaml_get("title"))
local author       = ask("Auteur (Prénom Nom)  ", yaml_get("author"))
local organization = ask("Organisation         ", yaml_get("organization"))
local place        = ask("Lieu                 ", yaml_get("place"))
...
print("\n" .. target .. " updated. Edit the compte-rendu body, then:")
